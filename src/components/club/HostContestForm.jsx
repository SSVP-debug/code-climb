  ...
  if (created) {
    ...
    return (
      <div className="text-center py-4">
        <p className="text-[var(--muted-foreground)] text-sm mb-1">Your contest is ready</p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="text-xs text-[var(--muted-foreground)] uppercase tracking-widest">Starts at</label>
          <input
            type="datetime-local"
            value={startsAt}
        ...
        <div>
          <label className="text-xs text-[var(--muted-foreground)] uppercase tracking-widest">Duration</label>
          <select
      ...
      <label className="flex items-center gap-2.5 cursor-pointer">
        ...
        />
        <span className="text-sm text-[var(--muted-foreground)]">Allow people to join after it starts</span>
      </label>
