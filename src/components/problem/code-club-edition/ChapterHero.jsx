...
function ChapterHero({ campaignProgress, currentChapter, onContinue }) {
  ...
  return (
    <div className="relative rounded-3xl overflow-hidden border border-zinc-800 bg-gradient-to-br from-teal-500/10 via-zinc-950 to-zinc-950 p-6 sm:p-10">
        ...
        <div className="mt-6 flex flex-col sm:flex-row sm:items-end gap-6">
          ...
          {currentChapter && (
            <div className="flex items-center gap-3">
              <span className="flex-shrink-0 p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 text-teal-400">
