...
export default function CommandCenterHero({ pendingCount = 0 }) {
  ...
  return (
    <div className="mb-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 sm:p-6 relative overflow-hidden">
      <div
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <p className="text-[10px] uppercase tracking-widest text-[var(--muted-foreground)] font-mono-ui mb-1">
            Code Club Command Center
          </p>
          <h1 className="text-2xl sm:text-3xl font-black text-[var(--foreground)] flex items-center gap-2.5">
