          ...
          <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 w-full max-w-md">
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 bg-green-500 hover:bg-green-400 transition text-black font-semibold py-3 rounded-xl"
              >
                Save
              </button>
              ...
              <button
                ...
                className="flex-1 bg-zinc-700 hover:bg-zinc-600 transition py-3 rounded-xl"
              >
                Cancel
              </button>
            </div>
